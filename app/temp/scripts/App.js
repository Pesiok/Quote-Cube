...
var Cube = function () {
    function Cube() {
        ...
        this.walls = [].concat(_toConsumableArray(document.querySelectorAll(".cube__wall")));
        //cube__object css modificators
        this.getWall = ["get-front", "get-back", "get-left", "get-right", "get-top", "get-bottom"];
    ...
    _createClass(Cube, [{
        ...
        value: function events() {
            ...
            document.addEventListener("DOMContentLoaded", function () {
                cube.addEventListener("click", _this.fetchQuote.bind(_this));
        ...
        key: "getRandomWall",
        value: function getRandomWall() {
            var prevRandWall = this.randWall,
        ...
        key: "getQuote",
        value: function getQuote(data) {
            var activeWall = this.walls[this.getWall.indexOf(this.randWall)];
            var queryString = "https://twitter.com/share?text=" + encodeURIComponent(data.quote + " ~ " + data.author);
        ...
        value: function fetchQuote() {
            ...
            fetch(endpoint, options).then(function (response) {
                ...
                _this2.getRandomWall();
                _this2.getQuote(data);
...
var Modal = function () {
    ...
    _createClass(Modal, [{
        ...
        value: function events() {
            ...
            document.addEventListener("DOMContentLoaded", function () {
                _this.modalBtn.addEventListener("click", _this.turnOffModal.bind(_this));
                _this.generatorBtn.addEventListener("click", _this.turnOnModal.bind(_this));
        ...
        value: function turnOffModal() {
            ...
            setTimeout(function () {
                return _this2.modal.classList.add("modal--disable");
            }, 501);
            this.modalBtn.classList.add("modal__btn--active");
        }
    }, {
        key: "turnOnModal",
        value: function turnOnModal() {
            var _this3 = this;

            this.modal.classList.remove("modal--disable");
            setTimeout(function () {
                return _this3.modal.style.transform = "translateY(0%)";
            }, 50);
...
var _particles = __webpack_require__(114);
...
var _Cube = __webpack_require__(115);
...
document.addEventListener("DOMContentLoaded", function () {
    Particles.init(_particles2.default);
});
